...
if(isset($_FILES['photo']) && $_FILES['photo']['error'] == UPLOAD_ERR_OK) {
   ...
   // If file upload fails or no file is uploaded
   $photoName = ""; // Set default value
}
    ...
    VALUES ('$firstName', '$lastName', '$age', '$gender', '$email', '$password', '$phone', '$city', '$shortBio', '$spokenLanguage', '$photoName')";
    // Execute the query
